...
COPY --chown=appuser:appuser . /home/appuser/app/grenseed

# Required in Windows and MAC OS to run the entrypoint.sh script
RUN sed -i 's/\r$//' /home/appuser/app/grenseed/entrypoint.sh \
    && chmod 744 /home/appuser/app/grenseed/entrypoint.sh

RUN mv /home/appuser/app/grenseed/entrypoint.sh /usr/local/bin/entrypoint.sh
